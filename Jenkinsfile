pipeline {
    ...
    post {
        ...
        success {
            slackSend color: "good", message: "El despliegue en el ambiente de ${env.JOB_NAME} Con numero de Build: ${env.BUILD_NUMBER} Se realizo correctamente por el usuario: ${env.CHANGE_AUTHOR}"
        }
        aborted {
